...
class DBConfig:
    ...
    user = os.getenv("DB_USER", "user_shop1")
    passwd = os.getenv("DB_PASSWD", "81921634dfce242")
    host = os.getenv("DB_HOST", "192.168.1.77")
    ...
    #!  esearch_uri = "localhost" пример
    # глупая заглушка порт дефолтный
    esearch_uri = "https://localhost:5000"
