...
class RegisterForm(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.user = None
    #! тут прийдется менять синатксис
    #https://stackoverflow.com/questions/75264402/how-to-fix-typeerror-validate-got-an-unexpected-keyword-argument-extra-valid
    # def validate(self):
...
class LoginForm(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.user = None
  #! и тут прийдется менять синатксис
    #https://stackoverflow.com/questions/75264402/how-to-fix-typeerror-validate-got-an-unexpected-keyword-argument-extra-valid
    # def validate(self):
    def validate(self, extra_validators=None):
        """Validate the form."""
